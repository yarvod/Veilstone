...
- **Notes:** Tracked by Phase A A8. Storage/block registry/generator/streamer construction now starts in composition, and runtime rebuild uses that context. Renderer still exposes and calls world lifecycle fields directly.
