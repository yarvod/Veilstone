...
- [x] Add idle, walk, turn, hurt/death animation state separation.
- [x] Avoid sliding/ice-skating mobs when they slow down, turn, or hit obstacles.
- [x] Sync future mob footstep sounds to animation contact phase.
