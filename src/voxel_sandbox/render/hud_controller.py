    ...
    def debug_overlay_snapshot(
        ...
        *,
        ...
        text = (
            ...
            f"Generation jobs {perf.queues.generation_jobs} "
            ...
            f"GPU uploads {perf.queues.completed_gpu_uploads} "
            f"Dirty chunks {perf.queues.dirty_chunks} "
            f"Pending saves {perf.queues.pending_saves}\n"
