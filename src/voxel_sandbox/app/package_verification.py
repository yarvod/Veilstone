...
def missing_package_resources() -> tuple[Path, ...]:
    ...
    required = (
        ...
        resource_path("config/entity_animations.toml"),
        resource_path("data/items.toml"),
        resource_path("data/blocks.toml"),
        resource_path("data/biomes.toml"),
        resource_path("data/resource_pack_mappings/minecraft_java.toml"),
        resource_path("resource_packs/default/assets/minecraft/sounds/ui/click.wav"),
        ...
        resource_path("resource_packs/default/assets/minecraft/sounds/entity/cow/hurt_1.wav"),
        resource_path("resource_packs/default/assets/minecraft/sounds/entity/zombie/hurt_1.wav"),
        resource_path("resource_packs/default/assets/minecraft/sounds/music/exploration.wav"),
