...
def missing_package_resources() -> tuple[Path, ...]:
    ...
    required = (
        ...
        resource_path("assets/entities/cow-skin.png"),
        resource_path("assets/entities/zombie-skin.png"),
        resource_path("assets/audio/cow/hurt_1.wav"),
        resource_path("assets/audio/zombie/hurt_1.wav"),
