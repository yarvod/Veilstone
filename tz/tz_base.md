...
- строгая оптимизация чанков, мешей и сетевого протокола (Отличные референсы по C-подобной оптимизации: `fogleman/Craft` и `fogleman/Minecraft`);
...
- ведение `docs/CHANGELOG.md` для фиксации известных ошибок, багов и текущего состояния контекста.
